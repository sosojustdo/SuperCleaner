...
public class MemoryCleanActivity$$ViewInjector {
  public static void inject(Finder finder, final com.yunthink.supercleanmaster.ui.MemoryCleanActivity target, Object source) {
    View view;
    ...
    view = finder.findRequiredView(source, 2131624157, "field 'cpu_Scan'");
    target.cpu_Scan = (android.widget.ImageView) view;
    view = finder.findRequiredView(source, 2131624158, "field 'cpu_Besom'");
    target.cpu_Besom = (android.widget.ImageView) view;
    view = finder.findRequiredView(source, 2131624159, "field 'cpu_Success'");
    target.cpu_Success = (android.widget.ImageView) view;
  ...
  public static void reset(com.yunthink.supercleanmaster.ui.MemoryCleanActivity target) {
    ...
    target.cpu_Scan = null;
    target.cpu_Besom = null;
    target.cpu_Success = null;
